...
export function isNumericClaimContent(claim: ClaimContent): claim is NumericClaimContent {
  return 'dataType' in claim && claim.dataType === 'numeric';
}

/** Type guard for string claim content */
export function isStringClaimContent(claim: ClaimContent): claim is StringClaimContent {
  return 'dataType' in claim && claim.dataType === 'string';
}

/** Type guard for object claim content */
export function isObjectClaimContent(claim: ClaimContent): claim is ObjectClaimContent {
...
export function isInlineClaim(claim: ClaimData): claim is InlineClaimData {
  return claim.claimType === 'inline';
}

/** Check if claim data is a source-backed claim (narrows to SourceBackedClaimData) */
export function isSourceBackedClaim(claim: ClaimData): claim is SourceBackedClaimData {
  return claim.claimType === 'source-backed';
}

/** Check if claim data is an aggregated claim (narrows to AggregatedClaimData) */
export function isAggregatedClaim(claim: ClaimData): claim is AggregatedClaimData {
  return claim.claimType === 'aggregation';
}

/** Type guard for NumericData */
export function isNumericData(data: NumericData | ClaimPointer | undefined): data is NumericData {
  return typeof data === 'object' && data !== null && 'value' in data;
}

/** Type guard for StringData */
export function isStringData(data: StringData | ClaimPointer | undefined): data is StringData {
  return typeof data === 'object' && data !== null && 'value' in data && typeof data.value === 'string';
}

/** Type guard for ClaimPointer */
export function isClaimPointer(data: NumericData | StringData | ClaimPointer | undefined): data is ClaimPointer {
  return typeof data === 'string';
}

/** Type guard for ObjectClaimData */
export function isObjectClaim(claim: ClaimData): claim is ObjectClaimData {
  return claim.dataType === 'object';
}

/** Type guard for NumericClaimData */
export function isNumericClaim(claim: ClaimData): claim is NumericClaimData {
  return claim.dataType === 'numeric';
}

/** Type guard for StringClaimData */
export function isStringClaim(claim: ClaimData): claim is StringClaimData {
 ...
 */
export function canonicalizeClaimForSigning(claim: ClaimContent): string {
