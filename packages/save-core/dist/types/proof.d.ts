...
export type TrustModel = 'reputational' | 'mathematical' | 'computation';
...
export type MathematicalMechanism = 'zk_tls_notary';
/** Mechanisms typically used with the computation trust model */
export type ComputationMechanism = 'cre_consensus' | (string & {});
/** Union of known mechanisms (used for tagging) */
export type ProofMechanism = ReputationalMechanism | MathematicalMechanism | ComputationMechanism;
...
export declare function isSignatureProof(proof: ProofData): proof is SignatureProofData;
/** Type guard for ZK-TLS Notary proof */
export declare function isZkTlsNotaryProof(proof: ProofData): proof is ZkTlsNotaryProofData;
/** Type guard for CRE Consensus proof */
export declare function isCreConsensusProof(proof: ProofData): proof is CreConsensusProofData;
export {};
