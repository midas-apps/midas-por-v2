 ...
 */
import type { HexString, SignatureProofData, ClaimContent } from '../types/index.js';
/** Options for signing a claim */
export interface SignClaimOptions {
 ...
 * ```
 */
export declare function signClaim(claim: ClaimContent, privateKey: HexString, options: SignClaimOptions): SignatureProofData;
/**
 ...
 */
export declare function createSignatureProof(options: {
 ...
 */
export declare function getClaimSigningData(claim: ClaimContent): string;
