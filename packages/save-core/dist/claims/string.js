 ...
 * ```
 */
export function createStringClaim(options) {
    return {
        id: options.id,
        claimType: 'inline',
        dataType: 'string',
...
export class StringClaim {
    ...
    constructor(id, data, description, proof, expectedValue) {
        this._id = id;
        this._data = data;
    ...
    static inline(options) {
        ...
        return new StringClaim(claim.id, data, claim.description, proof, claim.expectedValue);
    }
    /**
    ...
    static sourceBacked(options) {
        return new StringClaim(options.id, options.dataPointer, options.description, undefined, options.expectedValue);
    }
